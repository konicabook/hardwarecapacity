...
vmr_folder = r"D:\ITH\tempdownload\ca\202605\version_vmr_bak"
output_csv = r"D:\ITH\tempdownload\ca\202605\vmr_hardware_poc.csv"
...
with open(r"D:\ITH\tempdownload\ca\202605\vmr_hardware_poc_pos.csv", 'w', newline='', encoding='utf-8') as f:
    writer = csv.writer(f)
    writer.writerow(header) # write header to POS file  
    writer.writerows(pos_rows)
with open(r"D:\ITH\tempdownload\ca\202605\vmr_hardware_poc_sc.csv", 'w', newline='', encoding='utf-8') as f:
    writer = csv.writer(f)
