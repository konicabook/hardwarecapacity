...
def main():
    left_path = Path(r"D:\ITH\tempdownload\ca\202604\vmr_hardware_poc_pos.csv")
    right_path = Path(r"D:\ITH\tempdownload\ca\202604\output_ist.csv")
    output_path = Path(r"D:\ITH\tempdownload\ca\202604\vmr_pos_hardware_ist.csv")
